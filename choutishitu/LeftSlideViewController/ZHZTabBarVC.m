...
- (void)addOneChlildVc:(UIViewController *)childVc title:(NSString *)title imageName:(NSString *)imageName selectedImageName:(NSString *)selectedImageName
{
    ...
    textAttrs[NSBackgroundColorAttributeName] = [UIColor blackColor];
    textAttrs[NSFontAttributeName] = [UIFont systemFontOfSize:10];
    [childVc.tabBarItem setTitleTextAttributes:textAttrs forState:UIControlStateNormal];
    
    // 设置tabBarItem的选中文字颜色
    NSMutableDictionary *selectedTextAttrs = [NSMutableDictionary dictionary];
    selectedTextAttrs[NSBackgroundColorAttributeName] = [UIColor orangeColor];
...
//    ZHZTwoViewController *oneVC = [[ZHZTwoViewController alloc]init];
    ZHZNavitationVC *nav = [[ZHZNavitationVC alloc]initWithRootViewController:[[UIViewController alloc]init]];
